  ...
  <div class="about">
    ...
    <el-form label-width="120px" @submit.native.prevent="save">
        ...
        <el-form-item label="参考答案">
            <el-input v-model="model.answers"></el-input>
        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        async save(){
            // let res
            if(this.id){
                await this.$http.put(`/rest/interviews/${this.id}`,this.model)
            }else{
                await this.$http.post('/rest/interviews',this.model);
            }
        ...
        async fetch(){
            const res = await this.$http.get(`/rest/interviews/${this.id}`)
            this.model = res.data
        },
